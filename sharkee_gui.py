...
GUI_UPDATE_INTERVAL_MS = 17  # ~1000/60 ≈ 16.666ms → use 17ms integer

# Max items processed per GUI loop to avoid long blocking loops
...
"""
    ...
    def _start_gui_update_loop(self):
        # Start the periodic GUI update loop tuned to GUI_UPDATE_INTERVAL_MS (~60Hz)
        self.after(GUI_UPDATE_INTERVAL_MS, self._process_gui_queue)
    ...
    def _process_gui_queue(self):
        ...
        # Schedule next run to achieve ~60Hz refresh
        self.after(GUI_UPDATE_INTERVAL_MS, self._process_gui_queue)
